        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h2
              ...
              className="text-lg sm:text-xl lg:text-2xl font-medium text-slate-300 mb-5"
            >
            ...
            >
              ...
              <button
                ...
                className="px-6 py-2.5 border border-slate-600 text-slate-300 rounded-lg text-sm font-medium hover:border-slate-500 hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-slate-500/50 focus:ring-offset-2 focus:ring-offset-black"
              >
                {t.hero.getInTouch}
              </button>
            </motion.div>
            ...
            >
              <a
                ...
                download
                className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-slate-900/80 text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-800 hover:text-white transition-colors duration-200 border border-slate-700 hover:border-slate-600"
              >
