            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-8 border border-slate-700">
              ...
              <div className="flex flex-wrap gap-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-12 bg-slate-700 text-white rounded-lg flex items-center justify-center hover:bg-slate-600 transition-colors duration-300 border border-slate-600"
                  title="GitHub"
                >
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-12 bg-green-600 text-white rounded-lg flex items-center justify-center hover:bg-green-700 transition-colors duration-300"
                  title="WhatsApp"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
