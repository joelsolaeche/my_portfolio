        ...
        <div className={`flex justify-between items-center transition-all duration-300 ease-out ${
          ...
          <Link href="/" className="flex items-center">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className={`font-semibold text-zinc-100 tracking-tight hover:text-white transition-colors duration-200 ${
            ...
            <motion.button
              ...
              className={`ml-4 rounded-md font-medium transition-all duration-200 flex items-center gap-1.5 ${
                isInHero 
                  ? 'px-3 py-1.5 text-sm' 
                  : 'px-2.5 py-1 text-sm'
              } text-zinc-400 hover:text-zinc-100 border border-zinc-700/50 hover:border-zinc-600`}
            >
